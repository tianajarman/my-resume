...
def deploy():
    ...
    course1 = Course(course_number= 'MISY 225', title='Introduction to Programming Business Applications', description='Learning to program in Java.')
    ...
    course3 = Course(course_number='CISC 355', title='Computers, Ethics & Society', description='Analyzing the impact of computers on our society.')
